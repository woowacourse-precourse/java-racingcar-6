...
## 구현할 기능 목록
- [x] 자동차
  - [x] 주어진 횟수 동안 전진 또는 멈춤 기능.
  - [x] 전진조건 : 무작위값 (0 - 9) 4 이상일 경우. 
  - [x] 이름 값을 잘못 입력: IllegalArgumentException을 발생시킨 후 애플리케이션은 종료.

- [x] 게임
  - [x] 자동차 추가 기능 : 이름 5자 이하(쉼표로 구분 입력).
  - [x] 이동 횟수 입력 기능.
  - [x] 실행결과 알림 기능 : 각 자동차 전진 출력 + 자동차 이름 출력.
  
- [x] 게임 결과
  - [x] 우승자 알림 기능.
  - [x] 한 명 이상일때 쉼표로 구분 출력.
