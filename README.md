...
1. [ ] 클래스 구현 및 각 클래스의 필드와 생성자 구현

2. [ ] 각 'Car' 객체를 생성 및  초기화한다.
	- [ ] 사용자 입력을 ','로 구분하고, 각 차의 이름을 저장
	- [ ] 차량의 수만큼 'Car' 객체 생성 및 이름과 이동량 초기화

3. [ ] 총 이동 횟수를 입력받아 그 수만큼 각 차수 시행
	- [ ] 각 차수마다 모든 차량에 대해 0~9까지의 랜덤값 추출
	- [ ] 추출한 랜덤값을 기반으로 이동 여부 확인
	- [ ] 이동할 수 있다면, 차량의 위치 + 1

4. [ ] 모든 차량의 이동여부 확인이 끝나면, 각 차량의 이동량 출력
