...
## 구현할 기능 목록
- [ ] 자동차
  - [ ] 주어진 횟수 동안 전진 또는 멈춤 기능.
  - [ ] 전진조건 : 무작위값 (0 - 9) 4 이상일 경우. 

- [ ] 사용자
  - [ ] 자동차 추가 기능 : 이름 5자 이하(쉼표로 구분 입력).
  - [ ] 이동 횟수 입력 기능.
  - [ ] 값을 잘못 입력: IllegalArgumentException을 발생시킨 후 애플리케이션은 종료.

- [ ] 알림
  - [ ] 게임 진행 알림 기능 : 각 자동차 전진 출력 + 자동차 이름 출력.
  - [ ] 우승자 알림 기능 : 한 명 이상일때 쉼표로 구분 출력.
