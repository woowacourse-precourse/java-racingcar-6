...
---
## 기능 목록
- [x]자동차를 이동시킴 - Car#move()
- [x]자동차의 이름과 현재위치를 출력 - Car#showLocation()
- [x]이동횟수세팅 - Game#setMoveCount
- [x]우승자를 추출, 여러명일 수도 있음 - Game#getWinner();
- [x]차 이름 설정시 5자 이상이면, 오류 발생시키는 기능 - Car#Car()
## 🚀 기능 요구 사항
