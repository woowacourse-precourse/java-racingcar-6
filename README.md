...
1. 자동차 준비
   1. 이름이 부여된 자동차입력
   2. 이름은 5자 이하만 가능 이외에는 예외처리
   3. 자동차 이름을 쉼표 기준으로 구분하여 Map에 저장

2. 시도할 횟수 입력     

3. 자동차 전진
   1. 횟수마다 0~9사이 값을 랜덤으로 자동차마다 받기
   2. 무작위 값이 4 이상일 경우 전진
   3. 실행결과 자동차 이름 이랑 "-" 추가하여 출력

4. 최종 우승자
   1. 1개 이상의 최종 전진횟수가 많은 자동차 이름 출력
   2. 공동 우승자일 경우 쉼표를 이용하여 구분
