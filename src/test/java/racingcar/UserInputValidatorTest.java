...
public class UserInputValidatorTest {
    ...
    void true_return_when_inputCarName_is_normal() {
        ...
        Assertions.assertTrue(() -> carNameIsValid("12345"));
    ...
    void return_true_when_inputCarName_is_korAndSpecialChar() {
        ...
        Assertions.assertTrue(() -> carNameIsValid("한글과!차"));
        Assertions.assertTrue(() -> carNameIsValid("!](,"));
    }
    ...
    void return_true_when_inputCarName_hasBlank() {
        ...
        Assertions.assertTrue(() -> carNameIsValid("안 녕 하 세 요 "));
    }
