...
public class InputTest {
    ...
    public void 세_개의_이름을_입력받을_경우_테스트를_통과한다() {
        ...
        // when & then
        assertThatNoException(() -> carNameValidator.validateCount("a,b,c"));
    }
    ...
    public void 네_개의_이름을_입력받을_경우_예외를_반환한다() {
        // given
        // when & then
        assertThatIllegalArgumentException(() -> carNameValidator.validateCarName("a,b,c,d"));
    }
    ...
    public void 공백을_입력받을_경우_예외를_반환한다() {
        // given
        // when & then
        assertThatIllegalArgumentException(() -> carNameValidator.validateCarName(""));
    }
    ...
    public void 형식을_벗어난_경우_예외를_반환한다() {
        // given
        // when & then
        assertThatIllegalArgumentException(() -> carNameValidator.validateCarName("a,b,c,"));
    }
    ...
    public void 서로_다른_이름을_가졌을_경우_테스트를_통과한다() {
        // given
        // when & then
        assertThatNoException(() -> carNameValidator.validateDuplicate("a,b,c"));
    }
    ...
    public void 서로_같은_이름을_가졌을_경우_예외를_반환한다() {
        // given
        // when & then
        assertThatIllegalArgumentException(() -> carNameValidator.validateDuplicate("a,a,b"));
    }
}
