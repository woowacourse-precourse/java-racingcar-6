...
import static racingcar.tdd.config.ErrorMessage.INPUT_CAR_NAME_COMMA_ERROR_MESSAGE;
import static racingcar.tdd.config.InputPattern.INPUT_CAR_NAME_COMMA_REGEX;
import static racingcar.tdd.config.InputPattern.INPUT_CAR_NAME_LENGTH_REGEX;
import static racingcar.tdd.config.ErrorMessage.INPUT_CAR_NAME_LENGTH_ERROR_MESSAGE;
