...
class RefereeServiceTest {
    ...
    void testSelectWinnersWithSingleWinner() {
        ...
        List<RoundResultDto> roundResultDtos = Arrays.asList(round1);
        ...
        List<CarStatusDto> carDtos = Arrays.asList(dto1, dto2, dto3);

        RefereeService refereeService = new RefereeService();
        GameResultDto result = refereeService.publishGameResult(roundResultDtos, carDtos);
