...
public class RaceTest {
    ...
    void winnerCarsSearch() {
        ...
        Mockito.when(car1.getName()).thenReturn(WINNER);
        Mockito.when(car2.getName()).thenReturn(LOSER);
        Mockito.when(car1.getDistance()).thenReturn(2);
        Mockito.when(car2.getDistance()).thenReturn(1);
