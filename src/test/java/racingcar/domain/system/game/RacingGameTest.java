...
class RacingGameTest {
     ...
     */
    private static final Long[] COWINNER_MOVE_DATA = {MOVE, MOVE, STOP, MOVE, MOVE, STOP, MOVE,
        MOVE, MOVE};
    ...
    void coWinnerStart() {
        ...
        TestCarNameReader carNameReader = new TestCarNameReader();
        TestTryCountReader tryCountReader = new TestTryCountReader();
        Host host = new CoWinnerTestHost();
        GameFactory factory = new ConsoleGameFactory();
        InMemoryCarManager carManager = new InMemoryCarManager();
        CarPositionManager carPositionManager = new InMemoryCarPositionManager();
    ...
    private static class CoWinnerTestHost extends Host {
        ...
        @Override
        protected MoveSignal getSignal() {
            return MoveSignal.of(COWINNER_MOVE_DATA[idx++]);
        }
    }
}