...
public class RacingGameTest {
    ...
    void playGame_메서드_사용시_랜덤한_값이_4_미만인_경우_자동차_정지() {
        racingGame.playGame(RandomSingleNumber.of(NUM_LOWER_THAN_FOUR, NUM_LOWER_THAN_FOUR));
    ...
    void playGame_메서드_사용시_랜덤한_값이_4_이상인_경우_자동차_전진() {
        racingGame.playGame(RandomSingleNumber.of(NUM_FOUR, NUM_FOUR));
        racingGame.playGame(RandomSingleNumber.of(NUM_HIGHER_THAN_FOUR, NUM_HIGHER_THAN_FOUR));
