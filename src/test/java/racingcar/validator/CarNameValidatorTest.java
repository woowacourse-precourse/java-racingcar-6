...
class CarNameValidatorTest {
    ...
    void validateSeparator(String input) {
        ...
        Throwable exception = getException(input);
        // then
        assertEquals(ErrorMessage.ONLY_COMMA, exception.getMessage());
    }
    ...
    void validateEndWithComma(String input) {
        ...
        // then
        assertEquals(ErrorMessage.NOT_ALLOW_END_WITH_COMMA, exception.getMessage());
    }
    ...
    void validateCarNameLength(String input) {
        ...
        // then
        assertEquals(ErrorMessage.NAME_BETWEEN_ONE_AND_FIVE, exception.getMessage());
    }
    ...
    void validateCarNameCond(String input) {
        ...
        // then
        assertEquals(ErrorMessage.CAR_NAME_COND, exception.getMessage());
    }
    ...
    void validateIsStartBlank(String input) {
        ...
        // then
        assertEquals(ErrorMessage.NOT_ALLOW_BLANK_IN_START, exception.getMessage());
    }
    ...
    void validateIsEndBlank(String input) {
        ...
        // then
        assertEquals(ErrorMessage.NOT_ALLOW_BLANK_IN_END, exception.getMessage());
    }
    ...
    void validateDuplication(String input) {
        ...
        // then
        assertEquals(ErrorMessage.NOT_ALLOW_NAME_DUPLICATION, exception.getMessage());
    }
