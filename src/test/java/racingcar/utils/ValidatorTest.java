...
class ValidatorTest {
    ...
    void validateCarNames1() {
        List<String> names = CarNameValidator.validateCarNames("test,abcde,abc");
    ...
    void validateCarNames2() {
        assertThatThrownBy(() -> CarNameValidator.validateCarNames("test,abcdef,abc"))
    ...
    void validateCarNames3() {
        assertThatThrownBy(() -> CarNameValidator.validateCarNames("test, ,abc"))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> CarNameValidator.validateCarNames("test,,abc"))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void validateCarNames6() {
        assertThatIllegalArgumentException().isThrownBy(() -> CarNameValidator.validateCarNames("test"));
    }

    @DisplayName("같은 이름을 입력한 경우 예외 발생")
    @Test
    void validateCarNames7() {
        assertThatIllegalArgumentException().isThrownBy(() -> CarNameValidator.validateCarNames("test,test,abc"));
    }
