...
class GameManagerTest {
    ...
    void testProceed_and_testGetCurrentCarStates() {
        ...
        for (String car : CAR_SAMPLES) {
            assertThat(carStates.get(car)).isEqualTo(times[idx++]);
        }
    }
    ...
    void testImmutabilityOfReturnedObjectOfGetCurrentCarStates() {
        ...
        assertThat(gameManager.getCurrentCarStates().get(CAR_SAMPLES[0]))
    ...
    void testGetWinners_oneWinner() {
        ...
        assertThat(winners.get(0)).isEqualTo(CAR_SAMPLES[0]);
    }
    ...
    void testGetWinners_twoWinners() {
        ...
        assertThat(winners).contains(CAR_SAMPLES[0], CAR_SAMPLES[1]);
    }
    ...
    void testGetWinners_noProceed() {
        ...
        assertThat(winners).contains(CAR_SAMPLES[0], CAR_SAMPLES[1], CAR_SAMPLES[2]);
    }
    ...
    void testIsSuccessToProceed_randomness() {
        ...
        assertThat(results).contains(!firstValue);
    }
}