...
public class ViewMessage {
    public static final String PRINT_NAME = "경주할 자동차 이름을 입력하세요.(이름은 쉼표(,) 기준으로 구분)";
    public static final String PRINT_TRY_NUMBER = "시도할 회수는 몇회인가요?";
    public static final String PRINT_RUN_RESULT = "실행 결과";
