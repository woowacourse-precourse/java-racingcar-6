...
public class ValidChecker {
    ...
    public void isAlphabetic(String car) {
    ...
    public void isDuplicated(String car) {
    ...
    public ArrayList<String> carListCheck(String input) {
    ...
    public void atMostFiveWords(String car) {
        if (car.length() > 5) {
            throw new IllegalArgumentException("자동차의 이름은 다섯 글자 이하만 가능합니다.");
        }
    }

    public int numberOfTryCheck(String input) {
        try {
