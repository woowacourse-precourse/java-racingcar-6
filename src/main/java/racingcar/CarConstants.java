...
public class CarConstants {
    ...
    public static final String NON_NUMERIC_INPUT_ERROR = "숫자가 아닌 문자가 입력되었습니다.";
    public static final String INVALID_INPUT_LENGTH_ERROR_MESSAGE = "입력은 1에서 5 사이의 글자여야 합니다.";
    public static final String DUPLICATE_NAME_ERROR = "중복된 이름이 있습니다.";
