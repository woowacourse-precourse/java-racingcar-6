...
import static racingcar.config.RacingConfig.ATTEMPT_COUNT_MAX;
import static racingcar.config.RacingConfig.ATTEMPT_COUNT_MIN;
import static racingcar.config.RacingConfig.CAR_NAME_SPLIT_DELIM;
import static racingcar.config.RacingConfig.INPUT_CAR_NAME_LENGTH_MAX;
import static racingcar.config.RacingConfig.INPUT_CAR_NAME_LENGTH_MIN;
import static racingcar.config.RacingConfig.SPLIT_CAR_NAME_LENGTH_MAX;
