...
public class TryNumberValidator {
    ...
    public static final String SMALLER_THAN_MIN_NUMBER_MSG = " 이상의 정수값만 입력할 수 있습니다.";
    ...
    public static void validateTryNumber(Integer number) {
        if (isLessThanMinTryNumber(number)) {
            throw new IllegalArgumentException(MIN_TRY_NUMBER + SMALLER_THAN_MIN_NUMBER_MSG);
        }
    }
