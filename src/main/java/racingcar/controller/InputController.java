...
public class InputController {
    public static RacingCars setRacingCars() {
        try {
            CarNameValidator validation = new CarNameValidator(InputView.readCarNames());
    ...
    public static int setRoundNum() {
        try {
            RoundNumValidator validation = new RoundNumValidator(InputView.readTryToMoveTurnCount());
