...
import static racingcar.util.message.InputMessage.GET_CAR_NAMES_MESSAGE;
import static racingcar.util.message.InputMessage.GET_TRY_COUNT_MESSAGE;
...
public class CarRaceController {
    ...
    private Cars createCars(String carNames) {
        return carsService.createCars(carNames, (NumberGenerator) numberGenerator);
    }
