...
public class Validator {
    ...
    private final static String OVER_LENGTH_ERROR = String.format("[ERROR] 이름은 %d글자 이하 여야 합니다.", Constants.MAX_LENGTH.getIntValue());
    private final static String NUMERIC_ERROR = "[ERROR] 숫자형식이 맞지 않는 문자를 입력하였습니다.";
    ...
    public void validateCarNameInput(String carNames) {
        ...
        if (carNames.startsWith(Constants.SEPARATOR.getStringValue()) || carNames.endsWith(Constants.SEPARATOR.getStringValue()))
