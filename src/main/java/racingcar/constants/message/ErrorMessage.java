...
public enum ErrorMessage {
    ...
    CAR_NAME_LENGTH_ERROR(String.format("자동차 이름은 %s자 이하만 가능합니다.", RacingCarRole.MAX_CAR_NAME_LENGTH.getValue())),
    CARS_COUNT_ERROR(String.format("자동차 이름을 %s개 이상 입력해주세요", RacingCarRole.MIN_CARS_COUNT.getValue())),
