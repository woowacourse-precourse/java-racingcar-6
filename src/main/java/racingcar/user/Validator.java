...
public class Validator {
    ...
    protected void carNameCheck(String input) throws IllegalArgumentException{
        if(input.length()>5){
    ...
    protected void duplicatedNameCheck(String[] input) throws IllegalArgumentException{
    ...
    protected void gameRoundCheck(String input) throws IllegalArgumentException{
