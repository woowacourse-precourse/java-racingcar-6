...
public class Validation {
    ...
    public void commasBlankCheck(String name, String[] names) {
        int cnt = 0;
        ...
        if (names.length != (cnt + 1))
            throw new IllegalArgumentException("입력한 문자열 중에 연속 해서 ','가 입력 되었습니다.");
    ...
    public void blankCheck(String[] names) {
        if (names[0].isEmpty()) {
            throw new IllegalArgumentException("아무것도 입력 되지 않았습니다.");
        }
    }
