...
public class OutputManager {
    public static final String REQUEST_CAR_NAME_INPUT = "경주할 자동차 이름을 입력하세요.(이름은 쉼표(,) 기준으로 구분)";
    public static final String REQUEST_GAME_COUNT_INPUT = "시도할 회수는 몇회인가요?";
    public static final String RESULT = "실행 결과";
    public static final String WINNER = "최종 우승자 : ";
    public static final String GAME_OVER = "게임을 종료합니다...";
