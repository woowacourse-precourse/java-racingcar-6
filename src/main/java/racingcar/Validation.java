...
public class Validation {
    private static final String COUNTS_NUMERIC_ERROR_MESSAGE = "시도 횟수는 자연수로 입력해주세요. 게임을 다시 실행해주세요.";
    ...
    private static final String CAR_NAME_SIZE_ERROR_MESSAGE = "이름은 5자 이하만 가능합니다. 게임을 다시 실행해주세요.";
    private static final String DUPLICATE_ERROR_MESSAGE = "이름이 중복되었습니다. 게임을 다시 실행해주세요.";
