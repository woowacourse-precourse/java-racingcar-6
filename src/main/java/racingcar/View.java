...
public class View {
    private static final String PLEASE_INPUT_CARS = "경주할 자동차 이름을 입력하세요.(이름은 쉼표(,) 기준으로 구분)";
    private static final String PLEASE_INPUT_ROUND = "시도할 회수는 몇회인가요?";
    ...
    public void showResult(String result) {
        System.out.print(RESULT_PREFIX + result);
    }
