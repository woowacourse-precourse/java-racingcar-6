...
public class NameValidator {
    ...
    private List<String> splitComma(String names) {
    ...
    private void correctNumberOfChar(List<String> carNameList) {
    ...
    private void hasOnlyAlphabets(List<String> carNameList) {
        for (String name : carNameList) {
