...
public class RacingCarGame {
    ...
    private static int validateTryCounts(String counts) {
        ...
        try {
            ...
            throw new IllegalArgumentException(Constants.EXCEPTION_GAME_TRY_COUNTS_FORMAT_MESSAGE);
        }

        if (tryCounts > MAX_GAME_TRY_COUNTS) {
            throw new IllegalArgumentException(Constants.EXCEPTION_GAME_TRY_COUNTS_SIZE_MESSAGE);
        }
        return tryCounts;
    }
