...
public class RacingGame implements Game {
        ...
        /**
         * 게임에 필요한 정보를 초기화합니다.
         * 플레이어로 부터 laps 응답 받습니다.
         * readyToRacingCar 메서드를 호출합니다.
         */
        ...
        /**
         * 플에이어로 부처 자동차 이름을 응답 받고, 경주에 참여할 자동차를 생성합니다.
         */
        ...
        /**
         * 경주 게임을 시작합니다.
         * 정해진 laps 만큼 반복 후 반복이 끝나면 finish 메서드를 호출합니다.
         */
        @Override
        public void start() {
