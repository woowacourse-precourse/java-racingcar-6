...
import racingcar.IO.NameInput;
import racingcar.IO.TrialInput;
...
public class Racing {
    ...
    public void printWinner() {
        ...
        List<String> winningCarNames = getPositionMatches(maxPosition);
        System.out.println("\n최종 우승자 : " + String.join(", ", winningCarNames));
    }

    private List<String> getPositionMatches(int position) {
