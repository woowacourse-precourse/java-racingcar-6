...
public class Application {
	...
	public static List<Car> carListInput() throws IllegalArgumentException {
		// 자동차 이름 입력
	...
	public static void diceThrow(List<Car> carList) {
		// 전진 조건 확인
		for (Car car : carList)
	...
	public static void printCarCurrentState(List<Car> carList) {
		// 자동차 현황 출력
		for (Car car : carList)
	...
	public static int countMax(List<Car> carList) {
		// 최고 점수만 가져옴
		int max = 0;
	...
	public static List<String> compareMax(List<Car> carList, int max) {
		// 승자 목록 생성
		List<String> winnerList = new ArrayList<String>();
