...
public class Application {
    ...
    static String WhoIsWinner(Car[] cars) {
        int max = 0;
    ...
    static void CalculateGoOrStop(Car[] cars) {
        for(Car car : cars){
    ...
    static int UserEnterRepeatNumber() throws IllegalArgumentException{
        System.out.println("시도할 회수는 몇회인가요?");
        return Integer.parseInt(readLine());
    }

    static Car[] UserEnterCarName() throws IllegalArgumentException {
