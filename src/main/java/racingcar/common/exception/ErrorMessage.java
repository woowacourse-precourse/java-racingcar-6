...
public enum ErrorMessage {
    ...
    INVALID_RACING_CAR_NAME_LENGTH(
            String.format("이름은 공백이 아니어야 하며, %d글자 이하여야 합니다.", RacingCarRule.MAX_RACING_CAR_NAME_LENGTH)),
    INVALID_RACING_CAR_NAME_FORMAT("이름은 알파벳이나 숫자로만 이루어져야 합니다."),
    INVALID_NUMBER_OF_RACING_CAR(
            String.format("등록할 수 있는 자동차는 최대 %d개 이하입니다.", RacingCarRule.MAX_RACING_CAR_SIZE)),
