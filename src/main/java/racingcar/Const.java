...
public class Const {
    ...
    public static final String ALERT_PRINT_RESULT_START = "실행 결과";
    public static final String MANY_GAMES_STRING = "시도할 회수는 몇회인가요?";
    public static final String WELCOME_STRING = "경주할 자동차 이름을 입력하세요.(이름은 " + SEPARATOR_NAME + "(" + SEPARATOR + ") 기준으로 구분)";
