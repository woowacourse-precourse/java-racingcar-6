...
- [x] `경주 생성` 기능 (`자동차들`, `경주결과`, `경주매니저`를 가짐)
- [ ] `경주 실행` 기능 (이동 시도 횟수만큼 `자동차들 이동`시킴)
- [ ] `경주 상태` 반환 기능
- [ ] `경주 결과` 반환 기능
...
- [x] `자동차 경주 세팅` 기능 (자동차 이름, 이동 시도 횟수 입력 받아 자동차들과 경주 생성)
- [ ] `자동차 경주 실행` 기능 (경주 상태 받아 출력)
- [ ] `자동차 경주 정리` 기능 (경주 결과 받아 출력)
...
- 역할 : 책임의 집합 (재사용성)
    - 진행자 → 경주 (Racing) + 경주 진행자 (RacingController)
