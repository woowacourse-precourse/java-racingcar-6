...
### 테스트
- [x] 1️⃣이름 입력 관련
  - [x] 이름이 5글자가 넘는 경우 예외가 던져지는지
  - [x] 이름이 5글자가 넘지 않는 경우 예외가 발생하지 않고 등록되는지
  - [x] 이름이 공백인 경우 예외가 던져지는지

- [x] 2️⃣ 시도 횟수 입력 관련
  - [x] 숫자가 아닌 경우 예외가 던져지는지

- [x] 3️⃣ 자동차 이동 관련
  - [x] 한 칸 전진할 경우 위치가 하나 증가하는지

- [x] 4️⃣ 경기 결과 관련
  - [x] 우승자가 여러명일 경우 여러명을 출력하는지
  - [x] 우승자가 한명일 경우 한명을 출력하는지
